	 ...
	 class Conexiones : Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase
        {
            ...
            internal static Database CrearBaseDatos()
            {
                try
                {
                    string connectionString = UTL.Seguridad.Decriptar(ConfigurationManager.ConnectionStrings["BDSIMAV"].ConnectionString);
            ...
            {
                pRespuesta.CodigoRespuesta = ConstantesGlobales.Codigos.ErrorNoControlado;
            ...
            private RespuestaGenerica<string> ActualizarContextInfo()
            {
                ...
                {
                    respuesta.CodigoRespuesta = ConstantesGlobales.Codigos.ErrorNoControlado;
